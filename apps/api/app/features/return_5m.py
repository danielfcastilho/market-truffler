"""return_5m — the M5 reference feature.
...
"5 minutes ago" is the canonical 1m candle at exactly
`member.m1.open_time - 5 minutes` — a precise time offset, never "the 5th
previous row". If that exact candle doesn't exist (a gap, a not-yet-synced
history, or the instrument simply hadn't been trading 5 minutes earlier),
