 ...
 * full viewport width, while Truffles/Scents stay at the shared layout's
 * narrower content width. The shared shell (sniffer/layout.tsx) stays
 * pixel-identical across every tab; only this page's content is
 * unconstrained.
 */
